...
A API permite cadastrar cursos, editar, listar, buscar e apagar. Tudo foi documentado no Swagger, e o banco de dados é criado automaticamente quando a API sobe.
